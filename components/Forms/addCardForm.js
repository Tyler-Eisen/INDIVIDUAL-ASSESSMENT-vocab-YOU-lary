  ...
  const domString = `
    <form id="${obj.firebaseKey ? `update-card--${obj.firebaseKey}` : 'submit-card'}" class="mb-4">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="title" aria-describedby="bookTitle" placeholder="Enter Card Title" value="${obj.title || ''}" required>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="definition" placeholder="Definition" value="${obj.deinition || ''}" required>
      </div>
